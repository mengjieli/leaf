...
var EliminationScene = /** @class */ (function () {
    function EliminationScene(world) {
        ...
        leaf.Res.getRes("pure-exml_json").load().then(function () {
            var json = leaf.Res.getRes("pure-exml_json").data["pure-chicken-show.json"];
            var exml = ecs.Entity.create().addComponent(eui.EXML, json);
