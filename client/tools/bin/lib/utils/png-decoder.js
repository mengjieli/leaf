...
var byte_array_1 = require("./byte-array");
var PNGDecoder = /** @class */ (function (_super) {
     ...
     */
    PNGDecoder.prototype.decode = function (bytes) {
     ...
     */
    PNGDecoder.prototype.readHead = function () {
     ...
     * 读取数据块内容
     */
    PNGDecoder.prototype.readContent = function (data) {
        var i = 0;
        while (true) {
    ...
    PNGDecoder.prototype.findBlockHead = function () {
    ...
    PNGDecoder.prototype.decodeIHDR = function (len, data) {
    ...
    PNGDecoder.prototype.decodePLTE = function (len, data) {
    ...
    PNGDecoder.prototype.decodetRNS = function (len, data) {
        var list = this.getData();
        //console.log(new Buffer(list.slice(this.position, this.position + len)));
        switch (data.colorType) {
            case 3:
    ...
    PNGDecoder.prototype.decodeIDAT = function (len, data) {
        var list = this.getData();
        //console.log(new Buffer(list.slice(this.position, this.position + len)));
        ...
        //console.log(buffer);
        var bytes = new byte_array_1.ByteArray(buffer);
    ...
    PNGDecoder.prototype.error = function (tip) {
