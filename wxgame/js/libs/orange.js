...
var orange;
(function (orange) {
    var BaseSync = /** @class */ (function () {
        function BaseSync() {
            this.serverTime = -1;
        }
        __decorate([
            orange.watch
        ], BaseSync.prototype, "serverTime", void 0);
        return BaseSync;
    }());
    orange.BaseSync = BaseSync;
    orange.baseSync = new BaseSync();
})(orange || (orange = {}));
var orange;
(function (orange) {
     ...
     */
    orange.extendClass = function (cls, getters, methods) {
...
(function (orange) {
    var NetConnection = /** @class */ (function () {
        ...
        NetConnection.prototype.setReadyFalse = function () {
            this.isReady = false;
        };
        /**
         * @internal
        ...
        NetConnection.prototype.getReady = function () {
            if (this.isReady)
                return;
            this.isReady = true;
            while (this.prepareMsgs.length) {
                var msg = this.prepareMsgs.shift();
                if (this._protocol) {
    ...
    var NetProxy = /** @class */ (function () {
        function NetProxy() {
            ...
            this.update = function () {
                if (!_this.active || !_this.connection)
                    return;
                var now = Date.now();
        ...
        NetProxy.prototype.start = function () {
            var _this = this;
            var c = setInterval(this.update, 16);
    ...
    var WebSocketClient = /** @class */ (function () {
        ...
        WebSocketClient.prototype._onConnectError = function (e) {
            if (this._connectReject) {
                ...
                var e_12 = new orange.Event(orange.Event.CONNECT_ERROR);
                e_12.$target = this;
                func(e_12);
            }
        };
...
(function (orange) {
    ...
    orange.SimpleStateMachine = SimpleStateMachine;
    ...
    orange.SimpleStateMachineState = SimpleStateMachineState;
})(orange || (orange = {}));
/**
 * @internal
 */
...
(function (orange) {
    ...
    (function (platform) {
        var WebsocketClient = /** @class */ (function () {
            ...
            WebsocketClient.prototype._onSocketOpen = function () {
                var _this = this;
                if (orange.debug) {
            ...
            WebsocketClient.prototype._onReceiveData = function (u8) {
                if (orange.debug) {
...
(function (orange) {
    var TaskList = /** @class */ (function () {
        ...
        TaskList.prototype.execute = function () {
            return __awaiter(this, void 0, void 0, function () {
                var e_13, _a, list, _b, _c, _d, type, f, e_13_1;
...
(function (orange) {
    ...
    function startup(params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var e_15, _a, starts_1, starts_1_1, call, e_15_1;
